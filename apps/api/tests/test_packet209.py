...
from app.domain.dna_generation import parse_dna_generation_output
...
def test_parse_dna_generation_output_handles_fenced_json():
    parsed = parse_dna_generation_output('```json\n{"kind":"brand_dna_generation","dna":{"headline":"ok"}}\n```')
    assert parsed == {'kind': 'brand_dna_generation', 'dna': {'headline': 'ok'}}
